...
PICO Vision Algorithm Engineer 面试备考仓库（XR_Vision）。
...
- [NVIDIA DRIVE 索引](./nvidia/README.md)
- [系统设计（log ingestion / GPU scheduler / sensor fusion）](./nvidia/01-系统设计.md)
- [C++ 与嵌入式底层](./nvidia/02-C++与嵌入式底层.md)
