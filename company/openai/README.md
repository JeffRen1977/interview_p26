...
> **从这里开始备战：** [tlm-embedded-4week-prep-plan.md](./tlm-embedded-4week-prep-plan.md)（4 周日程，按日映射本仓文档与手撕）
...
| [edge-collaborative-agent-runtime.md](./edge-collaborative-agent-runtime.md) | **完整设计：** 边缘协同 Agent Runtime（QUIC/Outbox、CRDT、动态 Quorum、WAL） |
| [tlm-embedded-4week-prep-plan.md](./tlm-embedded-4week-prep-plan.md) | **备战计划：** TLM Embedded Experiences 4 周硬核复习（映射本仓材料） |
...
| [tlm-embedded-4week-prep-plan.md](./tlm-embedded-4week-prep-plan.md) | **从这里开始：** 4 周日程 + 每日材料映射 |
...
| **P0** | 边缘协同 Runtime（弱网 CRDT / Quorum / Outbox） |
